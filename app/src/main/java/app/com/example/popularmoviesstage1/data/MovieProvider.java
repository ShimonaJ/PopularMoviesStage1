...
/**
 * Created by Shimona on 11/9/2015.
 */
...
//        private Cursor getMovieByLocationSettingAndDate(
...
//
//            return sMovieByLocationSettingQueryBuilder.query(mOpenHelper.getReadableDatabase(),
//                    projection,
...
//            case WEATHER_WITH_LOCATION:
        ...
        public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
            ...
            switch (sUriMatcher.match(uri)) {
                ...
                // "weather/*"
//                case WEATHER_WITH_LOCATION: {
//                    retCursor = getMovieByLocationSetting(uri, projection, sortOrder);
//                    break;
//                }
                // "weather"
                case MOVIES: {
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        switch (match) {
            case MOVIES:
                ...
                getContext().getContentResolver().notifyChange(uri, null);
                return returnCount;
            case REVIEWS:  db.beginTransaction();
                returnCount = 0;
                try {
                    for (ContentValues value : values) {
                        //  normalizeDate(value);
                ...
                getContext().getContentResolver().notifyChange(uri, null);
                return returnCount;
            case TRAILERS:  db.beginTransaction();
                returnCount = 0;
                try {
                    for (ContentValues value : values) {
                        //  normalizeDate(value);
