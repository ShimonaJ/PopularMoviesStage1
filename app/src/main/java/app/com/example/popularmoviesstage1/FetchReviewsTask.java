...
import app.com.example.popularmoviesstage1.model.ListAdapter;
...
/**
 * Created by Shimona on 12/5/2015.
 */
public class FetchReviewsTask extends AsyncTask<String, Void, Void> {
    ...
    /*
        ...
        the database.
     */
//    List<Review> convertContentValuesToUXFormat(ContentValues[] cvv) {
...
//
//
//            movieItem = new Review(weatherValues.getAsString(MovieContract.MovieEntry.COLUMN_MOVIE_ID),
//
